...
#For encrpyting password?
# import urllib.parse
 
# urllib.parse.quote_plus("your_password")#
def testIDCollect(): #Test IDs for the drop down (returns a list)
    engine = create_engine('postgresql+psycopg2://sepp:password@127.0.0.1:5432/marking') #CHANGE THIS TO THE CONTAINER REFERENCE WHEN IT IS READY 
    try:
...
# SQLAlchemy engine
# `engine = create_engine('postgresql+psycopg2://sepp:password@127.0.0.1:5432/marking') 
